...
const countries = [
  ...
  },
  {
    ...
    why:        'Global Gate Jadibuti is Nepal\'s exclusive authorized UK university partner — giving you direct access to top UK universities other consultancies cannot offer. UK degrees take just 3 years (Bachelor) and 1 year (Master), saving time and tuition fees. The 2-year Graduate Route visa lets you work freely after graduation with no job offer required.',
  },
  {
    code:       'us',
    name:       'USA',
